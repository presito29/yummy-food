...
import { add } from '../State/Cart/Action';
...
const MenuCard = ({ hasColor, item }) => {
    ...
    return (
        <section className={`pt-[2rem] lg: flex relative bg-orange-200 m-4`}>
            <Accordion>
                <AccordionSummary
                ...
                >
                    <div className='lg:flex items-center justify-between'>
                        <div className='lg:flex items-center lg:gap-5'>
                            <img className='w-full h-auto object-cover' src={item.imagePath} alt="" />
